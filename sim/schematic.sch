...
load symbol RTL_MUX6148 work MUX pinBus I0 input.left [31:0] pinBus I1 input.left [31:0] pinBus I2 input.left [31:0] pinBus I3 input.left [31:0] pinBus O output.right [31:0] pinBus S input.bot [1:0] fillcolor 1
...
load symbol RTL_MUX6161 work MUX pin I0 input.left pin I1 input.left pin O output.right pinBus S input.bot [2:0] fillcolor 1
...
load symbol SingleBankMemory work:SingleBankMemory:NOFILE HIERBOX pin i_clk input.left pin i_clk_enable input.left pin i_nrst input.left pin i_read_enable input.left pin i_state input.left pin i_write_enable input.left pinBus i_address input.left [9:0] pinBus i_write_data input.left [31:0] pinBus o_read_data output.right [31:0] boxcolor 1 fillcolor 2 minwidth 13%
load symbol SingleBankMemory work:abstract:NOFILE HIERBOX pin i_clk input.left pin i_clk_enable input.left pin i_nrst input.left pin i_read_enable input.left pin i_state input.left pin i_write_enable input.left pinBus i_address input.left [9:0] pinBus i_write_data input.left [31:0] pinBus o_read_data output.right [31:0] boxcolor 1 fillcolor 2 minwidth 13%
...
load port i_clk input -pg 1 -lvl 0 -x 0 -y 2360
load port i_nrst input -pg 1 -lvl 0 -x 0 -y 2000
load port i_read_enable input -pg 1 -lvl 0 -x 0 -y 180
load port i_write_enable input -pg 1 -lvl 0 -x 0 -y 2700
load portBus i_address input [11:0] -attr @name i_address[11:0] -pg 1 -lvl 0 -x 0 -y 2720
load portBus i_state input [1:0] -attr @name i_state[1:0] -pg 1 -lvl 0 -x 0 -y 1490
load portBus i_write_data input [31:0] -attr @name i_write_data[31:0] -pg 1 -lvl 0 -x 0 -y 960
load portBus o_read_data output [31:0] -attr @name o_read_data[31:0] -pg 1 -lvl 6 -x 2280 -y 1400
load inst bank_read_data[0]_i RTL_MUX6148 work -attr @cell(#000000) RTL_MUX -pinBusAttr I0 @name I0[31:0] -pinBusAttr I0 @attr S=2'b00 -pinBusAttr I1 @name I1[31:0] -pinBusAttr I1 @attr S=2'b01 -pinBusAttr I2 @name I2[31:0] -pinBusAttr I2 @attr S=2'b10 -pinBusAttr I3 @name I3[31:0] -pinBusAttr I3 @attr S=2'b11 -pinBusAttr O @name O[31:0] -pinBusAttr S @name S[1:0] -pg 1 -lvl 5 -x 2150 -y 1400
load inst clk_enable_0_i RTL_AND1 work -attr @cell(#000000) RTL_AND -pg 1 -lvl 3 -x 1150 -y 1700
load inst clk_enable_1_i RTL_AND1 work -attr @cell(#000000) RTL_AND -pg 1 -lvl 3 -x 1150 -y 1770
load inst clk_enable_2_i RTL_AND1 work -attr @cell(#000000) RTL_AND -pg 1 -lvl 3 -x 1150 -y 1840
load inst clk_enable_3_i RTL_AND1 work -attr @cell(#000000) RTL_AND -pg 1 -lvl 3 -x 1150 -y 1910
load inst control_signals[0][clk_en]_i RTL_ROM1023 work -attr @cell(#000000) RTL_ROM -pinBusAttr A @name A[2:0] -pg 1 -lvl 1 -x 190 -y 1830
load inst control_signals[0][clk_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 1 -x 190 -y 1940
load inst control_signals[0][read_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb000 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 330
load inst control_signals[0][read_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 480
load inst control_signals[0][write_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb000 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 1830
load inst control_signals[0][write_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 1290
load inst control_signals[1][clk_en]_i RTL_ROM1023 work -attr @cell(#000000) RTL_ROM -pinBusAttr A @name A[2:0] -pg 1 -lvl 1 -x 190 -y 2170
load inst control_signals[1][clk_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 1 -x 190 -y 2060
load inst control_signals[1][read_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb001 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 190
load inst control_signals[1][read_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 70
load inst control_signals[1][write_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb001 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 2690
load inst control_signals[1][write_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 2260
load inst control_signals[2][clk_en]_i RTL_ROM1023 work -attr @cell(#000000) RTL_ROM -pinBusAttr A @name A[2:0] -pg 1 -lvl 1 -x 190 -y 2410
load inst control_signals[2][clk_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 1 -x 190 -y 2280
load inst control_signals[2][read_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb010 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 720
load inst control_signals[2][read_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 870
load inst control_signals[2][write_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb010 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 1690
load inst control_signals[2][write_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 1410
load inst control_signals[3][clk_en]_i RTL_ROM1023 work -attr @cell(#000000) RTL_ROM -pinBusAttr A @name A[2:0] -pg 1 -lvl 1 -x 190 -y 2630
load inst control_signals[3][clk_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 1 -x 190 -y 2520
load inst control_signals[3][read_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb011 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 1020
load inst control_signals[3][read_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 1170
load inst control_signals[3][write_en]_i RTL_MUX6161 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=3'sb011 -pinAttr I1 @attr S=default -pinBusAttr S @name S[2:0] -pg 1 -lvl 2 -x 630 -y 1550
load inst control_signals[3][write_en]_i__0 RTL_MUX3 work -attr @cell(#000000) RTL_MUX -pinAttr I0 @attr S=1'b0 -pinAttr I1 @attr S=default -pg 1 -lvl 2 -x 630 -y 600
load inst control_signals_reg[0][clk_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 2 -x 630 -y 2000
load inst control_signals_reg[0][read_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 540
load inst control_signals_reg[0][write_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 1350
load inst control_signals_reg[1][clk_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 2 -x 630 -y 2120
load inst control_signals_reg[1][read_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 180
load inst control_signals_reg[1][write_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 2320
load inst control_signals_reg[2][clk_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 2 -x 630 -y 2410
load inst control_signals_reg[2][read_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 930
load inst control_signals_reg[2][write_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 1610
load inst control_signals_reg[3][clk_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 2 -x 630 -y 2580
load inst control_signals_reg[3][read_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 1230
load inst control_signals_reg[3][write_en] RTL_REG_SYNC__BREG_4102 work -attr @cell(#000000) RTL_REG_SYNC -pg 1 -lvl 3 -x 1150 -y 1470
load inst gen_banks[0].BANK SingleBankMemory work:SingleBankMemory:NOFILE -autohide -attr @cell(#000000) SingleBankMemory -pinBusAttr i_address @name i_address[9:0] -pinBusAttr i_write_data @name i_write_data[31:0] -pinBusAttr o_read_data @name o_read_data[31:0] -pg 1 -lvl 4 -x 1810 -y 880
load inst gen_banks[1].BANK SingleBankMemory work:abstract:NOFILE -autohide -attr @cell(#000000) SingleBankMemory -pinBusAttr i_address @name i_address[9:0] -pinBusAttr i_write_data @name i_write_data[31:0] -pinBusAttr o_read_data @name o_read_data[31:0] -pg 1 -lvl 4 -x 1810 -y 1110
load inst gen_banks[2].BANK SingleBankMemory work:abstract:NOFILE -autohide -attr @cell(#000000) SingleBankMemory -pinBusAttr i_address @name i_address[9:0] -pinBusAttr i_write_data @name i_write_data[31:0] -pinBusAttr o_read_data @name o_read_data[31:0] -pg 1 -lvl 4 -x 1810 -y 1340
load inst gen_banks[3].BANK SingleBankMemory work:abstract:NOFILE -autohide -attr @cell(#000000) SingleBankMemory -pinBusAttr i_address @name i_address[9:0] -pinBusAttr i_write_data @name i_write_data[31:0] -pinBusAttr o_read_data @name o_read_data[31:0] -pg 1 -lvl 4 -x 1810 -y 1570
load inst sel_d_reg[1:0] RTL_REG__BREG_4101 work[1:0]ssww -attr @cell(#000000) RTL_REG -pg 1 -lvl 4 -x 1810 -y 1820
...
netloc i_nrst 1 0 4 20 2000N 370 540N 990 620 1460
...
netloc i_read_enable 1 0 2 NJ 180 470
...
load net i_state[1] -attr @rip(#000000) i_state[1] -pin clk_enable_0_i I1 -pin clk_enable_1_i I1 -pin clk_enable_2_i I1 -pin clk_enable_3_i I1 -port i_state[1]
...
netloc i_write_enable 1 0 2 NJ 2700 470
...
netbloc @i_address 1 0 4 40 2720 430 390N 1030 600 1500
load netBundle @i_state 2 i_state[1] i_state[0] -autobundled
netbloc @i_state 1 0 4 NJ 1490 NJ 1490 890 1530 1680
...
netbloc @i_write_data 1 0 4 NJ 960 NJ 960 930J 1010 1640
...
netbloc @o_read_data 1 5 1 N 1400
...
netbloc @bank_read_data 1 4 1 2020 950n
...
netbloc @bank_read_data_1 1 4 1 2000 1180n
...
netbloc @bank_read_data_2 1 4 1 N 1410
...
netbloc @bank_read_data_3 1 4 1 2000 1430n
load netBundle @sel_d 2 sel_d[1] sel_d[0] -autobundled
netbloc @sel_d 1 4 1 2020 1480n
levelinfo -pg 1 0 190 630 1150 1810 2150 2280
pagesize -pg 1 -db -bbox -sgen -170 0 2450 2800
show
fullfit
#
